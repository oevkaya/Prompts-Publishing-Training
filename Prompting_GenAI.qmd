...
- Provide examples whenever it is needed

- Specify the desired length of the output
  * such as length of response in number of words etc.
...
- Use embeddings-based search to implement efficient knowledge retrieval 
  * May sounds more technical, such as RAG method but nowadays easy to create custom GPTs etc with additionally uploaded external resources in certain formats

- Use code execution to perform more accurate calculations or call external APIs
  * Such as guiding LLM to do something with another tool!

- Give the model access to specific functions or tools or apps online
  * like adding Figma as external tool etc. 
...
Consider playing with some base templates with these strategies 
...
::: {.callout-note}
Example with NewBooksScotland2026.pdf file for custom GPTs
:::
...
- Or easy to download [Ollama](https://ollama.com/) for open source local model experiments
